...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):        
        ...
        buttons = [[
            InlineKeyboardButton("❗️Hᴇʟᴩ❗️", callback_data="help")
            ],[      
            InlineKeyboardButton("⚠️Aʙᴏᴜᴛ⚠️", callback_data="about")
        ]]
        await query.edit_message_text(START_MESSAGE.format(user=query.from_user.mention, bot=client.mention), reply_markup=InlineKeyboardMarkup(buttons))
       
    elif query.data == "help":
        buttons = [[
            InlineKeyboardButton('⚙️ Aᴅᴍɪɴ Pᴀɴᴇʟ ⚙️', 'admin')            
            ],[
            InlineKeyboardButton('♻️ Bᴏᴛ Sᴛᴀᴛᴜꜱ ♻️', 'stats')
            ],[
            InlineKeyboardButton('✘ Cʟᴏꜱᴇ', 'close_data'),
            InlineKeyboardButton('« Bᴀᴄᴋ', 'start')           
        ]]
        await query.edit_message_text(script.HELP_TXT.format(query.from_user.mention), reply_markup=InlineKeyboardMarkup(buttons))  
        ...
        await query.edit_message_text(script.ABOUT_TXT.format(temp.B_NAME), reply_markup=InlineKeyboardMarkup(buttons))
        
    elif query.data == "source":
        buttons = [[
            InlineKeyboardButton('ꜱᴏᴜʀᴄᴇ ᴄᴏᴅᴇ', url='https://t.me/GODLike_razith')
            ],[
            InlineKeyboardButton('‹ Bᴀᴄᴋ', 'about')
        ]]
        await query.edit_message_text(script.SOURCE_TXT, reply_markup=InlineKeyboardMarkup(buttons))
        ...
        await query.edit_message_text(script.ADMIN_TXT, reply_markup=InlineKeyboardMarkup(buttons))
        ...
        await query.edit_message_text(script.FILTER_TXT, reply_markup=InlineKeyboardMarkup(buttons))
        ...
        await query.edit_message_text(script.AUTOFILTER_TXT, reply_markup=InlineKeyboardMarkup(buttons))
        ...
        await query.edit_message_text(script.MANUELFILTER_TXT, reply_markup=InlineKeyboardMarkup(buttons))
        ...
        await query.edit_message_text(script.GLOBALFILTER_TXT, reply_markup=InlineKeyboardMarkup(buttons))
        ...
        await query.edit_message_text(script.BUTTON_TXT, reply_markup=InlineKeyboardMarkup(buttons))
        ...
        await query.edit_message_text(script.CONNECTION_TXT, reply_markup=InlineKeyboardMarkup(buttons))
        ...
        await query.edit_message_text(script.FILE_TXT, reply_markup=InlineKeyboardMarkup(buttons))
        ...
        await query.edit_message_text(script.EXTRAMOD_TXT, reply_markup=InlineKeyboardMarkup(buttons))
        ...
        await query.edit_message_text(script.GROUPMANAGER_TXT, reply_markup=InlineKeyboardMarkup(buttons))           
        ...
        await query.edit_message_text(script.STATUS_TXT.format(total, users, chats, monsize, free), reply_markup=InlineKeyboardMarkup(buttons))
